		...
		<div class="md:col-span-12 lg:col-span-8 col-span-12">
			...
			<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
				...
				<div class="mb-6">
					...
					<div class="grid grid-cols-2 gap-4">
						<div>
							...
							<input wire:model='firs_name' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('first_name') border-red-500 @enderror" id="first_name" type="text">
							</input>
							@error('first_name')
				...
				<ul class="grid w-full gap-6 md:grid-cols-2">
					<li>
						<input wire:model='payment_method' class="hidden peer" id="hosting-small" name="hosting" required="" type="radio" value="hosting-small" />
					...
					<li>
						<input wire:model='payment_method' class="hidden peer" id="hosting-big" name="hosting" type="radio" value="hosting-big">
